            ...
            <div class="body_offwhite">
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">                   
                    <div className="col-lg-5 col-md-5 col-sm-12 col-xs-12 ">                       
                        ...
                        <div className="col-lg-5 col-md-1 col-sm-5 col-xs-1 "></div>{/* end of col-5 */}
                        <div className="col-lg-1 col-md-1 col-sm-1 col-xs-1 ">  
                        <div className="row">
                        <div className="btn-group ">
                        <button type="button" class="btn btn-default dropdown-toggle transcript_menu" data-toggle="dropdown">
                       ...
                       <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 "><div className="row"> <hr /></div></div>
                       <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 "><div className="row"><button className="btn my_btn">See more transcripts</button><br /><br /></div></div>
                        </div>{/* end of row */}
                        </div>{/* end of col-12 */}
                    </div>{/* end of col-6 */}
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div className="row">
                       <div className="btn-search_icon"><i className="fa fa-search"></i></div>
                       <div className="input_search"> <input className="form-control my_form_control" type="text" placeholder="Schools, Students, transcripts etc." aria-label="Search" /></div>
                       </div>{/**end of row */}
                    </div>{/**end of col-12 */}
                    ...
                    <h3>Create</h3>
                        <h1><i className="fa fa-file-text"></i></h1>
                       
                    </div>{/* end of col-6 */}
                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 icons_circle ">
                    <h3>Share</h3>
                        <h1><i className="fa fa-share-alt"></i></h1>
